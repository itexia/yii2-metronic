 ...
 *
 * DetailView is best used for displaying a model in a regular format (e.g.
 * each model attribute is displayed as a row in a table.) The model can be
 * either an instance of [[Model]] or an associative array.
 *
...
class DetailView extends \yii\widgets\DetailView
{
    ...
    /**
     * @var string|callback the template used to render a single attribute. If
     *   a string, the token `{label}` and `{value}` will be replaced with the
     *   label and the value of the corresponding attribute. If a callback
     *   (e.g. an anonymous function), the signature must be as follows:
     *
     * ~~~
