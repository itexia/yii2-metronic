...
class Modal extends Widget
{
     ...
     * The close button is displayed in the header of the modal window.
     *   Clicking
     * on the button will hide the modal window. If this is null, no close
     ...
     *   form. The submit button is displayed in the header of the modal
     *   window.
     *   Clicking on the button will submit the form of the modal window. If
     *   this is null, no submit button will be rendered.
     *
     * The following special options are supported:
     *
     * - tag: string, the tag name of the button. Defaults to 'button'.
    ...
    protected function renderAdditionalButton($button)
    {
        ...
        if (isset($button['url'])) {
            return Html::a($button['title'], $button['url'],
              $button['options'] ?? []);
        }
    ...
    protected function initOptions()
    {
        ...
        if ($this->clientOptions !== false) {
            $this->clientOptions = array_merge(['show' => false],
              $this->clientOptions);
        }
